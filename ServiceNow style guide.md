...
7. Capitalize only first letter of the __field label__. Abbreviations can be considered as an exception. Examples: "Due date", "JWT token".
8. Capitalize each word of the __table label__. Examples: "Catalog Task", "Support Group".
